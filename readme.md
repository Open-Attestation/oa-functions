...
The function invokes [@govtechsg/open-attestation](https://github.com/Open-Attestation/oa-verify) library and returns the result of the verifications performed on the provided document.
...
- [@govtechsg/open-attestation](https://github.com/OpenCerts/verify): Extension of [@govtechsg/oa-verify](https://github.com/Open-Attestation/oa-verify) providing a new verifier checking issuer identity upon Opencerts registry.
